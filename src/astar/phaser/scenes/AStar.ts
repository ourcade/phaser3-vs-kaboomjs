...
export default class AStar extends Phaser.Scene
{
	...
	create()
	{
		// NOTE: realistically would use Tiled or similar to create a tilemap
		// doing it by hand for comparison with Kaboom.js
		const level = [
		...
		this.easystar.setAcceptableTiles([Tile.Grass, Tile.Grass2])
